...
void Gen5_frames10()
{
  ...
  frame.data[4] = get_lock_target_adjusted_value(ESP_19_counter2 + 0xFA, false); // VL - wheel speed 0xDB
  frame.data[5] = get_lock_target_adjusted_value(ESP_19_counter, false);         // VL - wheel speed -- affects if =0x0B
  frame.data[6] = get_lock_target_adjusted_value(ESP_19_counter2 + 0xFA, false); // VR - wheel speed 0xDB
