...
void modeChangeExtLong(void)
{
  ...
  if (extButtonForce5050)
  {
    // for external flag - to be added
  }
}
...
void setupButtons()
{
  ...
  btnMode_ext.bind(Event_LongKeyPress, 0, &modeChangeExtLong); // apply to 'mode change ext'
}
