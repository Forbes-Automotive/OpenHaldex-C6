...
uint32_t lastABSResponse = 0;
bool isABSValid = false;
uint32_t absTimeout = 500;
...
bool tcForce5050 = false;
bool tcForce5050Flag = false;
bool extButtonForce5050 = false;
bool extButtonForce5050Flag = false;
